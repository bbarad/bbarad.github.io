...
<!-- <a href="http://www.codecogs.com/eqnedit.php?latex=EMRinger\&space;Score_{threshold}=\frac{10\cdot&space;Zscore_{threshold}}{\sqrt{Model\&space;Length}}" target="_blank"> --><img src="http://latex.codecogs.com/gif.latex?EMRinger\&space;Score_{threshold}=\frac{10\cdot&space;Zscore_{threshold}}{\sqrt{Model\&space;Length}}" title="EMRinger\ Score_{threshold}=\frac{10\cdot Zscore_{threshold}}{\sqrt{Model\ Length}}" class="img-responsive center-block" alt="EMRinger Score Equation"/>
